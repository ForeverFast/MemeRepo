...
namespace Web.Core.Store.AppData.Effects.TagActionsEffects.DeleteTagActionsEffects
{
    internal class DeleteTagActionEffect : BaseDataEffect<DeleteTagAction>
    {
        ...
        public DeleteTagActionEffect(IDALQueryChain<MemeRepoDbContext> dal, IMapper mapper, IFileStorageProvider fileStorageProvider, IState<AppDataState> appDataState) : base(dal, mapper)
        {
